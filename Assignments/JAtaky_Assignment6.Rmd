...
n<- 2 # SSSSSCCCCC CCCCCSSSSS

poss <- factorial(syc+cyp)  # permutation of all trees


prob = n/poss

total <- format(prob, scientific = TRUE, digits = 3)

paste0("The probability is ", total)


paste0("Rounding up, the probability is ", round(prob, 4))
